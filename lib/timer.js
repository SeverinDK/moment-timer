(function(root, undefined) {
    ...
    function Interval(callback, duration, autorun) {
    ...
    function Timeout(callback, duration, autorun) {
        this.timer = new Timer(duration);
        this.callback = callback;
        this.timeout;
    ...
    moment.fn.interval = function(callback, duration, autorun = true) {
        return new Interval(callback, duration, autorun);
    };

    moment.fn.timeout = function(callback, duration, autorun = true) {
        return new Timeout(callback, duration, autorun);
    };
