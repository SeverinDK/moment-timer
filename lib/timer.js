(function(root, undefined) {
    ...
    function Interval(callback, duration, wait) {
    ...
    function Timeout(callback, duration, wait) {
        this.timer = new Timer(duration);
        this.callback = callback;
        this.timeout;
    ...
    if (!moment) {
        throw "Moment Timers cannot find Moment.js";
    }

    moment.fn.interval = function(callback, duration, wait) {
        return new Interval(callback, duration, wait);
    };

    moment.fn.timeout = function(callback, duration, wait) {
        return new Timeout(callback, duration, wait);
    };
